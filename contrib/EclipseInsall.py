...
print "author: Anton Mitrokhin, 2016"
...
try:
    ...
    print "You can try downloading Eclipse here: https://eclipse.org/downloads/download.php?file=/technology/epp/downloads/release/neon/1a/eclipse-cpp-neon-1a-linux-gtk-x86_64.tar.gz" 
    exit(1)

add_eclipse_launcher()
print "Do not forget to install JDK!"
